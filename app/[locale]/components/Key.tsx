...
export const Key = memo(function Key({
  ...
  const innerBaseClasses = 'w-full h-full flex items-center justify-center rounded-md font-normal text-xl transition-[transform,background-color] duration-150 active:duration-0 active:scale-90';
